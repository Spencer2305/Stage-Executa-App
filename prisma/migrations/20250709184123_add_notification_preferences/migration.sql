...
-- AlterTable
ALTER TABLE "assistants" ADD COLUMN     "advanced_settings" JSONB,
ADD COLUMN     "behavior_settings" JSONB,
ADD COLUMN     "handoffEnabled" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "handoff_settings" JSONB,
ADD COLUMN     "knowledge_settings" JSONB,
...
CREATE TABLE "notification_preferences" (
    ...
    "handoff_requests" BOOLEAN NOT NULL DEFAULT true,
    "assistant_alerts" BOOLEAN NOT NULL DEFAULT true,
